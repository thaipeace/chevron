...
export class TruckStopModel extends DefaultObject implements ICoordinateModel {
  KEY: string = PayloadsConstant.TRUCK_STOP.OBJECT_FIND;
  coordinates: GeoPoint[];
  centerBound: GeoPoint;
  name: string;

  constructor(_data = {}) {
    super(_data, 'TruckStopId');
    this.generateGeofenPoints();
    this.name = this.getValue('TruckStopName');
  }
}
