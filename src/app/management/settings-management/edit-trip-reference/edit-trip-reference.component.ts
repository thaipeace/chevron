...
@Component({
  selector: 'app-edit-trip-reference',
  templateUrl: './edit-trip-reference.component.html',
  styleUrls: ['./edit-trip-reference.component.scss']
})
export class EditTripReferenceComponent extends DefaultComponent implements OnInit, OnChanges, IDynamicComponent {
  ...
  onUpdateParamValue() {
    ...
    //   [this.selectedParam.id, this.selectedParam.category, this.selectedParam.name, this.selectedParam.type,
